CREATE TABLE `daily_vol_signals` (
...
CREATE INDEX `daily_vol_signals_index_ts_code` ON `daily_vol_signals` (`ts_code`);
CREATE INDEX `daily_vol_signals_index_trade_date` ON `daily_vol_signals` (`trade_date`);
CREATE UNIQUE INDEX `daily_vol_signals_unique` ON `daily_vol_signals` (`ts_code`, `trade_date`);
