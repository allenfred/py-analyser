CREATE TABLE `stock_daily_signals` (
  ...
  `up_ema_spider` tinyint(2) COMMENT 'EMA金蜘蛛',
  `down_ma_spider` tinyint(2) COMMENT 'MA毒蜘蛛',
  `down_ema_spider` tinyint(2) COMMENT 'EMA毒蜘蛛',
  `up_td8` tinyint(2),
  `up_td9` tinyint(2),
  `down_td8` tinyint(2),
  `down_td9` tinyint(2),
  ...
  `ma_down_arrange203060` tinyint(1),
  `ma_down_arrange2060120` tinyint(1),
  `ema_down_arrange51020` tinyint(1),
  `ema_down_arrange5102030` tinyint(1),
  `ema_down_arrange510203060` tinyint(1),
  `ema_down_arrange203060` tinyint(1),
  `ema_down_arrange2055120` tinyint(1),
...
CREATE INDEX `stock_daily_signals_index_ts_code` ON `stock_daily_signals` (`ts_code`);
CREATE INDEX `stock_daily_signals_index_trade_date` ON `stock_daily_signals` (`trade_date`);
CREATE UNIQUE INDEX `stock_daily_signals_unique` ON `stock_daily_signals` (`ts_code`, `trade_date`);