...
def analytic_signals(df):
    ...
    global short_ma_arrange1
    global short_ma_arrange2
    global short_ema_arrange1
    global short_ema_arrange2

    global middle_ma_arrange1
    global middle_ma_arrange2
    global middle_ema_arrange1
    global middle_ema_arrange2

    global long_ma_arrange1
    global long_ma_arrange2
    global long_ema_arrange1
    global long_ema_arrange2

    global ma_gold_cross1
    global ma_gold_cross2
    global ma_gold_cross3
    global ma_gold_cross4
    global ema_gold_cross1
    global ema_gold_cross2
    global ema_gold_cross3
    global ema_gold_cross4

    global ma_out_sea
    global ema_out_sea

    global ma_hold_moon
    global ema_hold_moon

    global ma_over_gate
    global ema_over_gate
    ...
    df['ma120_up'] = np.nan
    df['ema120_up'] = np.nan
    df['ma_arrange'] = np.nan
    df['ema_arrange'] = np.nan

    df['short_ma_arrange1'] = np.nan
    df['short_ma_arrange2'] = np.nan
    df['short_ema_arrange1'] = np.nan
    df['short_ema_arrange2'] = np.nan

    df['middle_ma_arrange1'] = np.nan
    df['middle_ma_arrange2'] = np.nan
    df['middle_ema_arrange1'] = np.nan
    df['middle_ema_arrange2'] = np.nan

    df['long_ma_arrange1'] = np.nan
    df['long_ma_arrange2'] = np.nan
    df['long_ema_arrange1'] = np.nan
    df['long_ema_arrange2'] = np.nan

    df['ma_gold_cross1'] = np.nan
    df['ma_gold_cross2'] = np.nan
    df['ma_gold_cross3'] = np.nan
    df['ma_gold_cross4'] = np.nan
    df['ema_gold_cross1'] = np.nan
    df['ema_gold_cross2'] = np.nan
    df['ema_gold_cross3'] = np.nan
    df['ema_gold_cross4'] = np.nan

    df['ma_glue'] = np.nan
    df['ema_glue'] = np.nan
    df['ma_out_sea'] = np.nan
    df['ema_out_sea'] = np.nan
    df['ma_hold_moon'] = np.nan
    df['ema_hold_moon'] = np.nan
    df['ma_over_gate'] = np.nan
    df['ema_over_gate'] = np.nan
    df['ma_up_group'] = np.nan
    df['ema_up_group'] = np.nan
    ...
    df['hammer'] = np.nan
    df['pour_hammer'] = np.nan
    df['short_end'] = np.nan
    df['swallow_up'] = np.nan
    df['attack_short'] = np.nan
    df['first_light'] = np.nan
    df['sunrise'] = np.nan
    df['flat_base'] = np.nan
