...
def long_signals(df):
    ...
    for index, row in df.iterrows():
        ...
        if is_ma_spider2(df, row, index):
            ma_spider_2.insert(index, 1)
        else:
            ma_spider_2.insert(index, 0)
        ...
        if is_ema_spider2(df, row, index):
            ema_spider_2.insert(index, 1)
        else:
            ema_spider_2.insert(index, 0)
    ...
    # MA银山谷（5/10，5/20，10/20）
    set_ma_silver_valley(df)

    # EMA银山谷（5/10，5/20，10/20）
    set_ema_silver_valley(df)

    # MA金山谷（5/10，5/20，10/20）
    set_ma_gold_valley(df)

    # EMA金山谷(5/10,5/20,10/20)
...
def is_ma_spider(df, row, index):
    ...
    # 今日ma5/ma10/ma20多头发散
    if df.iloc[index - 1].ma5 == df.iloc[index - 1].ma10 == df.iloc[index - 1].ma20 and \
...
def is_ma_spider2(df, row, index):
    ...
    if df.iloc[index - 1].ma5 == df.iloc[index - 1].ma10 == df.iloc[index - 1].ma20 == df.iloc[index - 1].ma30 and \
...
def is_ema_spider(df, row, index):
    ...
    if df.iloc[index - 1].ema5 == df.iloc[index - 1].ema10 == df.iloc[index - 1].ema20 and \
...
def is_ema_spider2(df, row, index):
    ...
    if df.iloc[index - 1].ema5 == df.iloc[index - 1].ema10 == df.iloc[index - 1].ema20 == df.iloc[index - 1].ema30 and \
...
def is_ma_up_group(df, row, index):
    ...
    if (row.change >= 5 or row.pct_chg >= 5) and \
            ...
            (df.iloc[index - 1].open < df.iloc[index - 1].ma20 or df.iloc[index - 1].close < df.iloc[index - 1].ma20):
        return True
    else:
        return False
...
def is_ema_up_group(df, row, index):
    ...
    if (row.change >= 5 or row.pct_chg >= 5) and \
            ...
            (df.iloc[index - 1].open < df.iloc[index - 1].ema20 or df.iloc[index - 1].close < df.iloc[index - 1].ema20):
        return True
    else:
        return False
...
def is_ma_over_gate(df, row, index):
    ...
    if (row.change >= 5 or row.pct_chg >= 5) and \
            ...
            (df.iloc[index - 1].low < df.iloc[index - 1].ma5 or df.iloc[index - 1].low < df.iloc[index - 1].ma10 or
             df.iloc[index - 1].low < df.iloc[index - 1].ma20) and \
            df.iloc[index - 1].ma20_slope > 0 and df.iloc[index - 1].ma5 > df.iloc[index - 1].ma20 and \
            df.iloc[index - 1].ma10 > df.iloc[index - 1].ma20:
        return True
    else:
        return False
...
def is_ema_over_gate(df, row, index):
    ...
    if (row.change >= 5 or row.pct_chg >= 5) and \
            ...
            (df.iloc[index - 1].low < df.iloc[index - 1].ema5 or df.iloc[index - 1].low < df.iloc[index - 1].ema10 or
             df.iloc[index - 1].low < df.iloc[index - 1].ema20) and \
            df.iloc[index - 1].ema20_slope > 0 and df.iloc[index - 1].ema5 > df.iloc[index - 1].ema20 and \
            df.iloc[index - 1].ema10 > df.iloc[index - 1].ema20:
        return True
    else:
        return False
...
def is_ma_hold_moon(df, row, index):
    ...
    if (row.low < row.ma5 or row.low < row.ma10 or row.low < row.ma20) and row.ma5 > row.ma20 and \
            ...
            (df.iloc[index - 1].low < df.iloc[index - 1].ma5 or df.iloc[index - 1].low < df.iloc[index - 1].ma10 or
             df.iloc[index - 1].low < df.iloc[index - 1].ma20) and \
            df.iloc[index - 1].ma20_slope > 0 and df.iloc[index - 1].ma5 > df.iloc[index - 1].ma20 and \
            df.iloc[index - 1].ma10 > df.iloc[index - 1].ma20 and row.ma20_slope > 0 and row.ma60_slope > 0:
        return True
    else:
        return False
...
def is_ema_hold_moon(df, row, index):
    ...
    if (row.low < row.ema5 or row.low < row.ema10 or row.low < row.ema20) and row.ema5 > row.ema20 and \
            ...
            (df.iloc[index - 1].low < df.iloc[index - 1].ema5 or df.iloc[index - 1].low < df.iloc[index - 1].ema10 or
             df.iloc[index - 1].low < df.iloc[index - 1].ema20) and \
            df.iloc[index - 1].ema20_slope > 0 and df.iloc[index - 1].ema5 > df.iloc[index - 1].ema20 and \
            df.iloc[index - 1].ema10 > df.iloc[index - 1].ema20 and row.ema20_slope > 0 and row.ema60_slope > 0:
        return True
    else:
        return False
...
def set_ma_silver_valley(df):
    ...
    for index, row in df.iterrows():
        if index >= 10:
            gold_cross_cnt = 0
            if df['ma_gold_cross_1'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
            if df['ma_gold_cross_2'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
            if df['ma_gold_cross_3'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
...
def set_ema_silver_valley(df):
    ...
    for index, row in df.iterrows():
        if index >= 10:
            gold_cross_cnt = 0
            if df['ema_gold_cross_1'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
            if df['ema_gold_cross_2'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
            if df['ema_gold_cross_3'][index - 10: index].max() == 1:
                gold_cross_cnt += 1
...
def set_ma_gold_valley(df):
    ...
    for index, row in df.iterrows():
        if index >= 30:
            ...
            if df['ma_silver_valley'][index - 30: index].max() == 1 and gold_cross_cnt >= 2 and \
                    df.iloc[index - 30].ma20 < row.ma20 and row.ma20_slope > 0:
...
def set_ema_gold_valley(df):
    ...
    for index, row in df.iterrows():
        if index >= 30:
            ...
            if df['ema_silver_valley'][index - 30: index].max() == 1 and gold_cross_cnt >= 2 and \
                    df.iloc[index - 30].ema20 < row.ema20 and row.ema20_slope > 0:
